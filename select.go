...
func (s SelectEndPoint[T]) table2string() (string, error) {
	if s.Table == "" {
...
func (s SelectEndPoint[T]) fields2string() (string, error) {
	var query string
...
func (s SelectEndPoint[T]) conditions2string() (string, []any, error) {
	var (
		query             string
...
func (s SelectEndPoint[T]) appends2string() (string, error) {
	var query string
